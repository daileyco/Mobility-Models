# Script to create figure showing flux vs distance, population origin, population destination
...
## plot
### save figure
png("./03-Output/02-Figures/flows_v_distance_regions.png", units = "in", res = 300, width = 16, height = 9, pointsize = 10)
...
## plot
### save figure
png("./03-Output/02-Figures/flows_v_poporigin_regions.png", units = "in", res = 300, width = 16, height = 9, pointsize = 10)
par(mar = c(5.1,5.1,1.1,1.1))
...
## plot
### save figure
png("./03-Output/02-Figures/flows_v_popdestination_regions.png", units = "in", res = 300, width = 16, height = 9, pointsize = 10)
par(mar = c(5.1,5.1,1.1,1.1))
