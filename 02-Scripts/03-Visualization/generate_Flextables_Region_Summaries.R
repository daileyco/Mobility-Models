...
## load data
load("./03-Output/01-Tables/summary_tables.rdata")
...
st.list <- split(summary.table, case_when(summary.table$Period %in% c("2011-2020") ~ "2011-2020", 
                                          summary.table$Period %in% c("2011-2015", "2013") ~ "2011-2015",
                                          summary.table$Period %in% c("2016-2020", "2018") ~ "2016-2020"))




### add the full table to list
st.list <- c(list(full=summary.table), 
             st.list)
...
caps <- c("Commuting and Population Data by US Census Region, 2011-2020",
          paste0("Commuting",
                 c(" and Population", "", " and Population"),
                 " Data by US Census Region, ",
                 c("2011-2020", "2011-2015", "2016-2020")))
...
## save
save(sft.list, 
     file = "./03-Output/01-Tables/summary_flextables.rds")
